        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-[2px] flex items-center justify-center p-2 z-50" onClick={() => setState((s) => ({ ...s, showRules: false }))}>
          ...
          >
            ...
            <div className="space-y-3 text-[12px] leading-6" style={{ opacity: 0.9 }}>
              <p>Paranoia Chess is part of the variants of Yanevi family (this time developed by Kalin, Ivaylo and Cecilia). The fundaments were layed at the end of 2025 during a conversation on a chilly, rather rushed walk along the river. Of course, afterwards - during our trials with Ivaylo, and later on against the computer engine - what initially seemed a simple modest variant turned out to be more complex, making us remove some initial rule ideas like suicides, rooks as fifth columns, revealing a fifth column and playing on the same turn.</p>
